...
public class Grade extends Fragment {
    ...
    private String post_str_scroller = "0";
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    ...
                    //lt.setText("请求失败，请重试或重新登陆！").show().during(5000, 0);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //实例化Toast
        //lt = new LoadToast(getActivity()).setProgressColor(Color.RED).setTranslationY(GlobalVariable.height);
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    //构建文件名称
                    String bitName = sp1.getSelectedItem() + " " + sp2.getSelectedItem() + " " + sp3.getSelectedItem();
        ...
        mRefresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (SharePreferenceUtils.isLogin(getActivity().getApplicationContext())) {
                    ...
                    //lt.setText("你还没有登录，请先登录！").show().during(5000, 0);
                }
            }
        });
        ...
        sp3.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                int value = ((ValueMap) sp3.getSelectedItem()).getValue();
                post_str_scroller = String.valueOf(value);
            }
    ...
    private void doGet() {
        ...
        if (cancle) {
            ...
            showProgress(true);
            mGetDataTask = new getData(post_str_year, post_str_term, post_str_scroller);
    ...
    private void init(View v) {
        ...
        sp3 = (Spinner) v.findViewById(R.id.grade_sp_chengji);
        ...
        String[] scroller = res.getStringArray(R.array.chengji);
        ...
        ArrayAdapter<ValueMap> scrollerAdapter = new ArrayAdapter<ValueMap>(v.getContext(), android.R.layout.simple_dropdown_item_1line,
                bindOtherAdapter
                        (scroller));
        sp3.setAdapter(scrollerAdapter);
    ...
    public class getData extends AsyncTask<Void, Void, Boolean> {
        ...
        getData(String _xn, String _xq, String _sj) {
            this.xn = _xn;
            this.xq = _xq;
            this.sj = _sj;
        }
        ...
        protected Boolean doInBackground(Void... params) {
            if (getImgData(GlobalVariable.GradePicUrl, xq, xn, sj)) {
                return true;
            }
            return false;
        }
        ...
        private boolean getImgData(String url, String xq, String xn, String sj) {
            OKHttpUtils utils = OKHttpUtils.getInstanceUtils();
            try {
                String imgUrl = GlobalVariable.GradePicUrl + "xn=" + xn + "&xq=" + xq + "&sj=" + sj;
                Log.e("imgURL:", imgUrl);
