...
public class Sport extends Fragment {
    ...
    private class getSportData extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                final Request request = new Request.Builder().url(GlobalVariable.URL_DETAIL + number).build();
    ...
    private class ReLoginSportTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                Request request = new Request.Builder().post(formBody).url(GlobalVariable.URL_SPORT_SCOLLER).build();
